\ProvidesFile{ch-front.tex}[2021-01-04 front matter chapter]
%
...
\begin{acknowledgments}
  ...
  and Graduate School helped fund \PurdueThesis\ development.
\end{acknowledgments}
...
\begin{glossary}
  philtrum& the groove between the nose and upper lip on most primates\cr
  septem& the cartilage in the nose that separates the nostrils\cr
\end{glossary}
